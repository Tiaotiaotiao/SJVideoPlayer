...
Pod::Spec.new do |s|
    ...
    s.description  = 'https://github.com/Tiaotiaotiao/SJVideoPlayer/blob/master/README.md'
    s.homepage     = 'https://github.com/Tiaotiaotiao/SJVideoPlayer'
    s.license      = { :type => 'MIT', :file => 'LICENSE.md' }
    s.author       = { 'SanJiang' => 'changsanjiang@gmail.com' }
    s.platform     = :ios, '9.0'
    s.source       = { :git => 'https://github.com/Tiaotiaotiao/SJVideoPlayer.git', :tag => "v#{s.version}" }
    s.requires_arc = true
    s.dependency 'SJBaseVideoPlayer', :git => 'https://github.com/Tiaotiaotiao/SJBaseVideoPlayer.git'
